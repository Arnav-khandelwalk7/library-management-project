package librarymanagementproject1;
...
public class main {
    ...
    public static void login() {
        ...
        JLabel l1,l2;  
        f.getContentPane().setBackground(Color.decode("#ffff9d"));
        ...
        login_but.setBackground(Color.blue);
    ...
    try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/", "root", "khandelwal");
    ...
    public static void user_menu(String UID) {
        ...
        view_but.setForeground(Color.white);
        view_but.setBackground(Color.blue);
        ...
        my_book.setForeground(Color.white);
        my_book.setBackground(Color.blue);
    ...
    public static void admin_menu() {
        ...
        create_but.setForeground(Color.white);
        create_but.setBackground(Color.blue);
        ...
        users_but.setForeground(Color.white);
        users_but.setBackground(Color.blue);
        ...
        issued_but.setForeground(Color.white);
        issued_but.setBackground(Color.blue);
        ...
        add_user.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                    ...
                    g.getContentPane().setBackground(Color.decode("#ffff9d"));
        ...
        issue_book.setBackground(Color.blue);
        ...
        return_book.setBackground(Color.blue);
            ...
            public void actionPerformed(ActionEvent e){
                    ...
                    create_but.addActionListener(new ActionListener() {
                        ...
                        { 
                            ...
                            String s=String.valueOf(fine);
                            stmt1.executeUpdate("UPDATE ISSUED SET FINE="+s+" WHERE IID="+iid);  
